...
**Depends on:** Phase 38
**Plans:** 9 plans
  - [ ] 38.1-01-PLAN.md — Wave 0 RED test scaffolds (AST guards + functional fixtures + migration test scaffold + integration round-trip scaffold)
  - [ ] 38.1-02-PLAN.md — Wave 1 credential_store.py UUID generation + find_credential_by_id helper (R1)
  - [ ] 38.1-03-PLAN.md — Wave 1 database.py credential_id columns on both adapters + set_device_credential_binding method + eligibility flatten (R2 + R7-eligibility)
  - [ ] 38.1-04-PLAN.md — Wave 2 migration.py destructive drop-and-recreate with version-stamp + 3-block banner (R10 + idempotent ALTER for R2)
  - [ ] 38.1-05-PLAN.md — Wave 2 resolver credential_id keyword-only param (Tier-0 UUID short-circuit) on both proxmox_api.py + ssh_tools.py (R5)
...
| 38.1 Sitemap-keystore Credential Binding | v1.7 | 0/9 | Planned     | - |
