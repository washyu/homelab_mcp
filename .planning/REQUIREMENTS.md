...
- [x] **RES-02**: `homelab://vms` resource returns live VM list from Proxmox/Docker/LXD
- [x] **RES-03**: `homelab://devices` resource returns device inventory with last discovery data
