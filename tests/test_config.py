...
class TestMCPConfig:
    ...
    def test_default_config(self):
        ...
        env_vars = ['MCP_DEBUG', 'MCP_LOG_LEVEL', 'SSH_TIMEOUT', 'SSH_RETRIES', 
                   'DISCOVERY_BATCH_SIZE', 'DISCOVERY_TIMEOUT', 'ENABLE_POSTGRESQL', 
    ...
    def test_boolean_parsing_variations(self):
        ...
        for env_value, expected in test_cases:
            ...
            config = MCPConfig()
            assert config.debug is expected, f"Failed for '{env_value}', expected {expected}, got {config.debug}"
